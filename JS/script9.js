const questions = [
    {
        test_text: "Visit www.example.com or email info@example.com.",
        correct_pattern: "\\.",
        task_description: "Write a regex pattern that matches any literal dot (.) in the string."
    },
    {
        test_text: "The password is P@ssw*rd*.",
        correct_pattern: "\\*",
        task_description: "Write a regex pattern that matches any literal asterisk (*) in the string."
    },
    {
        test_text: "The path is C:\\Users\\Username\\.",
        correct_pattern: "\\\\",
        task_description: "Write a regex pattern that matches any literal backslash (\\) in the string."
    }
];
